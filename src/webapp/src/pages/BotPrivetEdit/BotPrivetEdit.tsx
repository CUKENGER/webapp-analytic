...
const BotPrivetEdit = () => {
	...
	const handleOff = () => {
		...
		setTimeout(() => {
			...
			toast({
				description: "Привет-бот успешно отключен"
			})
			navigate(`/projects/${id}/bot_privet`)
			reset()
		}, 1000)
    ...
    >
      <BlockTitle title="Привет-бот">Настройте привет-бот</BlockTitle>
      <div className="flex w-full flex-col gap-4">
        <BlockContainer className="mt-0 px-0">
          <BlockContentChevron
            className="py-3 pr-4 pl-0"
            param="Бот"
            value="Название бота №1"
            needHover={false}
          />
          <BlockContentChevron
            className="py-3 px-4 pl-0"
            param="Юзернейм"
            value="@bot_name_1"
            needHover={false}
          />
        ...
        <BlockContainer className="mt-0 px-0" itemClassName="pl-0">
          <SectionContainer hasBorder={false}>
            <SectionTitle
              title="Сообщение"
              className="border-b border-gray-stroke"
            />
            <SectionContainer>
            ...
            <div className="py-3 px-4">
              ...
              />
              {errors.message && (
                <Notice error>{errors.message.message}</Notice>
              )}
            </div>
          </SectionContainer>
        </BlockContainer>
          ...
          <SectionContainer hasBorder={false}>
            ...
            <SectionContainer>
              <div className="py-3 px-4">
                ...
                />
                {errors.buttonText && (
                  <Notice error>{errors.buttonText.message}</Notice>
                )}
              </div>
            </SectionContainer>
            <SectionContainer hasBorder={false}>
              <div className="py-3 px-4">
                <Controller
                  ...
                  render={({ field }) => (
                    <UITextField {...field} footerLabel="Ссылка для кнопки." />
                  )}
                />
                {errors.buttonLink && (
                  <Notice error>{errors.buttonLink.message}</Notice>
                )}
              </div>
            </SectionContainer>
          </SectionContainer>
