...
interface PropTypes {
  ...
  tooltipBottomY?: number
  tooltipY?: number // Позиц
  marginLeft: number
  chartHeight: number
}

export const useCoverageTooltipPosition = ({
  containerRef,
  tooltipMeasureRef,
  mainContainerRef,
  ...
  const handleHighlightClick = (
    ...
    requestAnimationFrame(() => {
      ...
      const tooltipBottomY2 = chartHeight - tooltipBottomY
      const calculatedTooltipY = tooltipBottomY2 - tooltipHeight
